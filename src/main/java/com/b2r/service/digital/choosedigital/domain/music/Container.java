...
public class Container {
	...
	private String downloadsAvailable;	
	...
	private String multiArtistCompilation;	
	...
	private String noSchemeSmallImageUrl;	
	private String noSchemeMediumImageUrl;	
	private String noSchemeLargeImageUrl;	
	 ...
	 */
	public String getDownloadsAvailable() {
		return downloadsAvailable;
	}
	/**
	 * @param downloadsAvailable the downloadsAvailable to set
	 */
	public void setDownloadsAvailable(String downloadsAvailable) {
	 ...
	 */
	public String getMultiArtistCompilation() {
		return multiArtistCompilation;
	}
	/**
	 * @param multiArtistCompilation the multiArtistCompilation to set
	 */
	public void setMultiArtistCompilation(String multiArtistCompilation) {
	...
	/**
	 * @return the noSchemeSmallImageUrl
	 */
	public String getNoSchemeSmallImageUrl() {
		return noSchemeSmallImageUrl;
	}
	/**
	 * @param noSchemeSmallImageUrl the noSchemeSmallImageUrl to set
	 */
	public void setNoSchemeSmallImageUrl(String noSchemeSmallImageUrl) {
		this.noSchemeSmallImageUrl = noSchemeSmallImageUrl;
	}
	/**
	 * @return the noSchemeMediumImageUrl
	 */
	public String getNoSchemeMediumImageUrl() {
		return noSchemeMediumImageUrl;
	}
	/**
	 * @param noSchemeMediumImageUrl the noSchemeMediumImageUrl to set
	 */
	public void setNoSchemeMediumImageUrl(String noSchemeMediumImageUrl) {
		this.noSchemeMediumImageUrl = noSchemeMediumImageUrl;
	}
	/**
	 * @return the noSchemeLargeImageUrl
	 */
	public String getNoSchemeLargeImageUrl() {
		return noSchemeLargeImageUrl;
	}
	/**
	 * @param noSchemeLargeImageUrl the noSchemeLargeImageUrl to set
	 */
	public void setNoSchemeLargeImageUrl(String noSchemeLargeImageUrl) {
		this.noSchemeLargeImageUrl = noSchemeLargeImageUrl;
	}
	/**
	 * @return the price
	 */
